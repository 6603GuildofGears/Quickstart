...
public class ColorOrder extends OpMode {
    ...
    public void init() {
        ...
        // Limelight setup
        // OPTIMAL SETTINGS (configure at http://limelight.local:5801/):
        // Input Tab:
        //   - Resolution: 960x720 40fps (or 1280x800 30fps for longer range)
        //   - Exposure: 200-400 (2-4ms) for indoor lighting
